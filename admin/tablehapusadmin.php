            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="https://wahyuabsensi.gunungmas-seluler.com/admin/proses.php?hapus_admin=<?PHP echo $data['id_user']?>"class="btn btn-info">Ya</a></td>
                  <td><a href="https://wahyuabsensi.gunungmas-seluler.com/admin/admin/"class="btn btn-danger">Tidak</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
