...
<div class="row">
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">Kelola Data Pelajaran
            ...
            <div class="panel-body">
                <div class="col-md-12">
                    <table id="table-data-mapel" class="table table-bordered table-striped dataTable" role="grid" aria-describedby="example1_info" style="width: 100%">
    ...
    @include('admin.dataMapel.addEditForm')
    </div><!-- /.col-->
@endsection
@section('js')
<script type="text/javascript">
$(document).ready(function() {
    var table = $('#table-data-mapel').dataTable({
        processing: false,
        serverSide: false,
        scrollY: false,
        scrollX: true,
    ...
    $('#simpan').click(function(event){
        ...
        $.ajax ({
            ...
            success:function(response){
                ...
                $('#table-data-mapel').DataTable().ajax.reload();
