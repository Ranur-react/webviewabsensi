...
<div id="content">
  <div id="content-header">
    <div id="breadcrumb"> <a href="https://absen-mtsannur.com/<?php echo $_SESSION['akses']; ?>/" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> Home</a>
      <a href="https://absen-mtsannur.com/admin/admin" class="tip-bottom"> Admin</a>
            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="https://absen-mtsannur.com/admin/proses.php?hapus_hadir=<?PHP echo $data['id']?>"class="btn btn-info">Ya</a></td>
                  <td><a href="https://absen-mtsannur.com/petugas_piket/hadir/"class="btn btn-danger">Tidak</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
