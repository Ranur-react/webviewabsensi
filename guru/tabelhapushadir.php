            ...
            <table class="table table-bordered data-table">
              ...
              <tbody>
                ...
                <tr class="gradeX">
                  ...
                  <td><a href="https://wahyuabsensi.gunungmas-seluler.com/admin/proses.php?hapus_hadir=<?PHP echo $data['id']?>"class="btn btn-info">Ya</a></td>
                  <td><a href="https://wahyuabsensi.gunungmas-seluler.com/petugas_piket/hadir/"class="btn btn-danger">Tidak</a></td>
                </tr>
                <?php $no++; } ?>
              </tbody>
            </table>
